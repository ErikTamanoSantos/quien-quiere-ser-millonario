...
<body>
    ...
    <main class="main-slider d-none">
        ...
        function print_page_from_data($questions_array, $images_array, $selected_indexes, $question_prefix, $correct_answer_prefix, $wrong_answer_prefix, $max_level) {
            ...
            echo "<input id='50-disabled' type='hidden' name='50-disabled' value='". (isset($_POST["50-disabled"]) ? $_POST["50-disabled"] : "0") ."'>";
            echo "<input id='add-time-disabled' type='hidden' name='add-time-disabled' value='". (isset($_POST["add-time-disabled"]) ? $_POST["add-time-disabled"] : "0") ."'>";
            echo "<input id='public-disabled' type='hidden' name='public-disabled' value='". (isset($_POST["public-disabled"]) ? $_POST["public-disabled"] : "0") ."'>";
